...
%% treeSGS
% hyper-parameters: k, ratio, pcut, binum
for k = 60
for ratio = 0.8
for pcut = 0.02:0.01:0.05
for binnum = [10 50 100]
...
[U_sps, V_sps, Cov_sps, Obj_sps, U_scale_his_sps] = ...
    TreeSGS_b(X, gamma, lambda, k, C, maxiter, [], [], group, mx, Vnorm, ratio, pcut, binnum);

save(['TreeSGS_b_p' num2str(pcut*100) '_' num2str(binnum)...
